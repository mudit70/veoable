...
import { HtmlLanguagePlugin, HTML_FILE_EXTENSIONS } from '@veoable/lang-html';
...
import { TypeormPlugin } from '@veoable/framework-typeorm';
import { DrizzlePlugin } from '@veoable/framework-drizzle';
import { MikroOrmPlugin } from '@veoable/framework-mikroorm';
import { SequelizePlugin } from '@veoable/framework-sequelize';
import { KnexPlugin } from '@veoable/framework-knex';
import { MongoosePlugin } from '@veoable/framework-mongoose';
import { AxiosPlugin } from '@veoable/framework-axios';
import { FetchPlugin } from '@veoable/framework-fetch';
import { RpcClientPlugin } from '@veoable/framework-rpc-client';
import { FastapiPlugin } from '@veoable/framework-fastapi';
import { SqlalchemyPlugin } from '@veoable/framework-sqlalchemy';
import { DjangoPlugin } from '@veoable/framework-django';
import { FlaskPlugin } from '@veoable/framework-flask';
import { HttpxPlugin } from '@veoable/framework-httpx';
import { GrpcioPlugin } from '@veoable/framework-grpcio';
import { AiohttpPlugin } from '@veoable/framework-aiohttp';
import { CeleryPlugin } from '@veoable/framework-celery';
import { TornadoPlugin } from '@veoable/framework-tornado';
import { PymongoPlugin } from '@veoable/framework-pymongo';
import { RedispyPlugin } from '@veoable/framework-redispy';
import { Boto3Plugin } from '@veoable/framework-boto3';
import { GcsPyPlugin } from '@veoable/framework-gcs-py';
import { AzureBlobPyPlugin } from '@veoable/framework-azure-blob-py';
import { KafkapyPlugin } from '@veoable/framework-kafkapy';
import { PikaPlugin } from '@veoable/framework-pika';
import { WsPyPlugin } from '@veoable/framework-ws-py';
import { ElasticPyPlugin } from '@veoable/framework-elastic-py';
import { MemcachePyPlugin } from '@veoable/framework-memcache-py';
import { PeeweePlugin } from '@veoable/framework-peewee';
import { TortoisePlugin } from '@veoable/framework-tortoise';
import { SqlmodelPlugin } from '@veoable/framework-sqlmodel';
import { TrpcPlugin } from '@veoable/framework-trpc';
import { GraphqlPlugin } from '@veoable/framework-graphql';
import { VuePlugin } from '@veoable/framework-vue';
...
import { AngularPlugin } from '@veoable/framework-angular';
import { SveltePlugin } from '@veoable/framework-svelte';
import { ReactQueryPlugin } from '@veoable/framework-react-query';
import { SwrPlugin } from '@veoable/framework-swr';
import { TrpcClientPlugin } from '@veoable/framework-trpc-client';
import { StateMgmtPlugin } from '@veoable/framework-state-mgmt';
import { DomPlugin } from '@veoable/framework-dom';
import { GinPlugin } from '@veoable/framework-gin';
import { EchoPlugin } from '@veoable/framework-echo';
import { FiberPlugin } from '@veoable/framework-fiber';
import { GoHttpPlugin } from '@veoable/framework-gohttp';
import { GrpcgoPlugin } from '@veoable/framework-grpcgo';
import { GosqlxPlugin } from '@veoable/framework-gosqlx';
import { ChiPlugin } from '@veoable/framework-chi';
import { MongogoPlugin } from '@veoable/framework-mongogo';
import { GoredisPlugin } from '@veoable/framework-goredis';
import { AsynqPlugin } from '@veoable/framework-asynq';
import { KafkagoPlugin } from '@veoable/framework-kafkago';
import { WsGoPlugin } from '@veoable/framework-ws-go';
import { ElasticGoPlugin } from '@veoable/framework-elastic-go';
import { MemcacheGoPlugin } from '@veoable/framework-memcache-go';
import { EntPlugin } from '@veoable/framework-ent';
import { AwsgoS3Plugin } from '@veoable/framework-awsgo-s3';
import { GcsGoPlugin } from '@veoable/framework-gcs-go';
import { AzureBlobGoPlugin } from '@veoable/framework-azure-blob-go';
import { ActixPlugin } from '@veoable/framework-actix';
import { AxumPlugin } from '@veoable/framework-axum';
import { WarpPlugin } from '@veoable/framework-warp';
import { PoemPlugin } from '@veoable/framework-poem';
import { RocketPlugin } from '@veoable/framework-rocket';
import { SpringPlugin } from '@veoable/framework-spring';
import { JpaPlugin } from '@veoable/framework-jpa';
import { GormPlugin } from '@veoable/framework-gorm';
import { LaravelPlugin } from '@veoable/framework-laravel';
import { PycliPlugin } from '@veoable/framework-pycli';
import { GocliPlugin } from '@veoable/framework-gocli';
import { RustcliPlugin } from '@veoable/framework-rustcli';
import { ReactNativePlugin } from '@veoable/framework-react-native';
import { ReactRouterPlugin } from '@veoable/framework-react-router';
import { RedirectsPlugin } from '@veoable/framework-redirects';
import { BundlerPlugin } from '@veoable/framework-bundler';
import { BullmqPlugin } from '@veoable/framework-bullmq';
import { KafkajsPlugin } from '@veoable/framework-kafkajs';
import { AmqplibPlugin } from '@veoable/framework-amqplib';
import { Amqp091GoPlugin } from '@veoable/framework-amqp091-go';
import { AwsS3TsPlugin } from '@veoable/framework-aws-s3-ts';
import { GcsTsPlugin } from '@veoable/framework-gcs-ts';
import { AzureBlobTsPlugin } from '@veoable/framework-azure-blob-ts';
import { IoredisPlugin } from '@veoable/framework-ioredis';
import { GrpcNodePlugin } from '@veoable/framework-grpc-node';
import { WsTsPlugin } from '@veoable/framework-ws-ts';
import { ElasticTsPlugin } from '@veoable/framework-elastic-ts';
import { MemcacheTsPlugin } from '@veoable/framework-memcache-ts';
import { MCPServerPlugin } from '@veoable/framework-mcp-server';
import { SqlxPlugin } from '@veoable/framework-sqlx';
import { DieselPlugin } from '@veoable/framework-diesel';
import { TonicPlugin } from '@veoable/framework-tonic';
import { MCPServerRustPlugin } from '@veoable/framework-mcp-server-rust';
import { TokioSpawnPlugin } from '@veoable/framework-tokio-spawn';
import { ReqwestPlugin } from '@veoable/framework-reqwest';
import { SeaormPlugin } from '@veoable/framework-seaorm';
import { MongorustPlugin } from '@veoable/framework-mongorust';
import { RedisrsPlugin } from '@veoable/framework-redisrs';
import { ApalisPlugin } from '@veoable/framework-apalis';
import { AwsrustS3Plugin } from '@veoable/framework-awsrust-s3';
import { GcsRsPlugin } from '@veoable/framework-gcs-rs';
import { AzureBlobRsPlugin } from '@veoable/framework-azure-blob-rs';
import { KafkarsPlugin } from '@veoable/framework-kafkars';
import { WsRsPlugin } from '@veoable/framework-ws-rs';
import { ElasticRsPlugin } from '@veoable/framework-elastic-rs';
import { MemcacheRsPlugin } from '@veoable/framework-memcache-rs';
import { LapinPlugin } from '@veoable/framework-lapin';
