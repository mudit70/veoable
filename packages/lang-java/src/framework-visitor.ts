...
/**
 * Visit context passed to Java framework visitors during AST walk.
 */
export interface JavaVisitContext {
...
/**
 * Java framework visitor interface. Dispatched for every AST node
 * during the tree-sitter walk.
 */
export interface JavaFrameworkVisitor extends FrameworkVisitor {
  readonly language: 'java';
  onNode(ctx: JavaVisitContext, node: SyntaxNode): void;
}
